...
def plotbar(dict):
    ...
    print("Année de livraison :",dict.pop(None))
...
def main():
    ...
    typeamenagement ={'Piste Cyclable':0,  'Bande Cyclable':0,  'Voie verte':0,  'Couloir bus velo non elargi':0,  'Couloir bus velo elargi':0, 'Goulotte ou rampe':0, 'Double sens cyclable':0,"Double sens cyclable":0,  'Chaussee à voie centrale banalisee (CVCB)':0}
    typeamenagement2 = {None:0,  'Couloir bus velo non elargi':0,  'Bande Cyclable':0,  'Couloir bus velo elargi':0,  'Double sens cyclable':0,'Chaussee à voie centrale banalisee (CVCB)':0,  'Piste Cyclable':0, "Voie verte":0}
    ...
    reglementation = {'Velo facultatif':0,  None:0,  'Velo obligatoire':0,  'Contresens (sens reserve)':0,  'Voie verte':0,  'Autre':0,  'Zone 30':0,  'Aire pietonne':0, "Sans objet":0}
    zonecirculationapaisee = {None:0, 'Zone 30':0, 'Aire Pietonne':0, 'Zone de rencontre':0}
    anneelivraison = {None:0,  2011:0,  2008:0,  2009:0,  2006:0,  2022:0,1999:0,  2003:0,  2004:0,  2005:0,  2017:0,  2015:0,  2018:0,  2010:0,  2000:0,  2001:0,  2013:0,  2020:0,  1998:0,  2007:0,  2014:0,  2021:0,  2019:0,  2012:0,  2016:0,  1996:0,  2002:0}
    longueurcalculee = 0
    for v in data:
    ...
    print("Nombre de piste sur le réseau :" , nbr_piste_super_struct)
    print("Longueur calculée :" , longueurcalculee)
